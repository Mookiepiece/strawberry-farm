  ...
  <div class="VPSource undoc">
    <details>
      <summary class="mat:air p-10 f2 fw6 [B] [CS]">
        <div class="svgbg">
          <!-- LICENSE CC0 https://simpleicons.org/ -->
          <svg v-if="extname === 'js'" viewBox="0 0 24 24">
            <path
              ...
              fill="url(#codeGradientRose)"
            />
          </svg>
          <svg v-if="extname === 'ts'" viewBox="0 0 24 24">
            <path
              ...
              fill="url(#codeGradientViolet)"
            />
          </svg>
          <svg v-if="extname === 'vue'" viewBox="0 0 24 24">
            <path
              d="M24,1.61H14.06L12,5.16,9.94,1.61H0L12,22.39ZM12,14.08,5.16,2.23H9.59L12,6.41l2.41-4.18h4.43Z"
              fill="url(#codeGradientVue)"
            />
          </svg>
        </div>

        {{ count }} L
        <span class="clr-2">{{ filename }}.{{ extname }}</span>
