...
function requireObjectAssign() {
  ...
  objectAssign = shouldUseNative() ? _Object$assign : function (target, source) {
    var from;
...
function requireHas() {
  ...
  hasRequiredHas = 1;
  has = _bindInstanceProperty(_context = Function.call).call(_context, Object.prototype.hasOwnProperty);
  return has;
}
...
function requireFactoryWithTypeCheckers() {
  ...
  factoryWithTypeCheckers = function factoryWithTypeCheckers(isValidElement, throwOnDirectAccess) {
    ...
    function createChainableTypeChecker(validate) {
      ...
      var chainedCheckType = _bindInstanceProperty(checkType).call(checkType, null, false);

      chainedCheckType.isRequired = _bindInstanceProperty(checkType).call(checkType, null, true);
    ...
    function createEnumTypeChecker(expectedValues) {
      ...
      function validate(props, propName, componentName, location, propFullName) {
        ...
        var valuesString = _JSON$stringify(expectedValues, function replacer(key, value) {
    ...
    function createUnionTypeChecker(arrayOfTypeCheckers) {
      if (!_Array$isArray(arrayOfTypeCheckers)) {
    ...
    function isNode(propValue) {
      switch (_typeof(propValue)) {
        ...
        case 'object':
          if (_Array$isArray(propValue)) {
            return _everyInstanceProperty(propValue).call(propValue, isNode);
          }
...
function hasClass(element, className) {
  ...
  return _indexOfInstanceProperty(_context = " " + (element.className.baseVal || element.className) + " ").call(_context, " " + className + " ") !== -1;
}
...
var Transition = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.onTransitionEnd = function onTransitionEnd(timeout, handler) {
    ...
    if (!node || doesNotHaveTimeoutOrListener) {
      _setTimeout(this.nextCallback, 0);
    ...
    if (timeout != null) {
      _setTimeout(this.nextCallback, timeout);
    }
  };
...
Transition.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  timeout: function timeout(props) {
    ...
    return pt.apply(void 0, _concatInstanceProperty(_context = [props]).call(_context, args));
  },
...
var _addClass = function addClass$1(node, classes) {
  ...
  return node && classes && _forEachInstanceProperty(_context = classes.split(' ')).call(_context, function (c) {
...
var removeClass = function removeClass(node, classes) {
  ...
  return node && classes && _forEachInstanceProperty(_context2 = classes.split(' ')).call(_context2, function (c) {
...
var CSSTransition = /*#__PURE__*/function (_React$Component) {
  ...
  function CSSTransition() {
    ...
    _this = _React$Component.call.apply(_React$Component, _concatInstanceProperty(_context3 = [this]).call(_context3, args)) || this;
...
function getChildMapping(children, mapFn) {
  ...
  if (children) _forEachInstanceProperty(_context = _mapInstanceProperty(Children).call(Children, children, function (c) {
    return c;
  })).call(_context, function (child) {
...
function mergeChildMappings(prev, next) {
  ...
  var nextKeysPending = _Object$create(null);
...
function getInitialChildMapping(props, onExited) {
  return getChildMapping(props.children, function (child) {
    return /*#__PURE__*/cloneElement(child, {
      onExited: _bindInstanceProperty(onExited).call(onExited, null, child),
      "in": true,
...
function getNextChildMapping(nextProps, prevChildMapping, onExited) {
  ...
  _forEachInstanceProperty(_context2 = _Object$keys(children)).call(_context2, function (key) {
...
var values = _Object$values || function (obj) {
  var _context;

  return _mapInstanceProperty(_context = _Object$keys(obj)).call(_context, function (k) {
    return obj[k];
  });
};
...
var TransitionGroup = /*#__PURE__*/function (_React$Component) {
  ...
  function TransitionGroup(props, context) {
    ...
    var handleExited = _bindInstanceProperty(_context2 = _this.handleExited).call(_context2, _assertThisInitialized(_this)); // Initial children should all be entering, dependent on appear
  ...
  _proto.render = function render() {
    ...
    var children = _mapInstanceProperty(_context3 = values(this.state.children)).call(_context3, childFactory);
...
var ReplaceTransition = /*#__PURE__*/function (_React$Component) {
  ...
  function ReplaceTransition() {
    ...
    _this = _React$Component.call.apply(_React$Component, _concatInstanceProperty(_context = [this]).call(_context, _args)) || this;
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React.createElement(TransitionGroup, props, inProp ? /*#__PURE__*/React.cloneElement(first, {
      key: 'first',
      onEnter: this.handleEnter,
      onEntering: this.handleEntering,
      onEntered: this.handleEntered
    }) : /*#__PURE__*/React.cloneElement(second, {
      key: 'second',
...
var leaveRenders = (_leaveRenders = {}, _leaveRenders[modes.out] = function (_ref) {
  ...
  return /*#__PURE__*/React.cloneElement(current, {
    "in": false,
  ...
  return [current, /*#__PURE__*/React.cloneElement(children, {
    "in": true,
...
export { CSSTransition as C, Transition as T };
