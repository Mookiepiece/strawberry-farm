...
import { on } from '../../strawberry-farm/functions/on';\r
import { Bag } from '@mookiepiece/strawberry-farm/functions';\r
\r
...
watchEffect(onCleanUp => {\r
  if (!props.disabled) {\r
    ...
    onCleanUp(\r
      on(document.body).dragleave(() => {\r
        dragging.value = false;\r
      }),\r
    );\r
  }\r
});\r
...
\r
label[data-dragging]::before {\r
  content: 'drop file here';\r
}\r
\r
label[data-dragover]::before {\r
  content: 'ohhhhh';\r
}\r
input {\r
