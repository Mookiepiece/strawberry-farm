...
export const useCalendar = (model: Ref<Dayjs>) => {\r
  ...
  // prettier-ignore\r
    switch (delta) {\r
      case -Infinity: model.value = model.value.startOf('M'); break;\r
      case Infinity:  model.value = model.value.endOf('M'); break;\r
      default:        model.value = model.value.add(delta, 'd');\r
    }\r
  };\r
    \r
