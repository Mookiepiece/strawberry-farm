...
import { useCalendar, VCalendar } from '@mookiepiece/strawberry-farm';\r
<\/script>\r
\r
...
const calendar = useCalendar(month);\r
\r
...
\r
  <VCalendar class="MonthlyFunding" v-model="month" :calendar change-on-keydown>\r
