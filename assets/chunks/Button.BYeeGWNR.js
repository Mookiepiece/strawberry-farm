...
<template>\r
  <div class="good">\r
    <VButton class="GhostButton size-s">\r
      <template #prefix>\r
        <i-feather i="airplay" />\r
      </template>\r
    </VButton>\r
    <VButton class="GhostButton size-s">Button</VButton>\r
    <VButton class="GhostButton size-s">\r
      <template #prefix>\r
        <i-feather i="airplay" />\r
      </template>\r
    ...
    <VButton class="GhostButton size-l">\r
      <template #prefix>\r
        <i-feather i="airplay" />\r
      </template>\r
    </VButton>\r
    <VButton class="GhostButton size-l">Button</VButton>\r
    <VButton class="GhostButton size-l">\r
      <template #prefix>\r
        <i-feather i="airplay" />\r
      </template>\r
