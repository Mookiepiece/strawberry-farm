import{r as i,M as f,a as n,F as c,j as t,B as a,b as l}from"./index.085f51cf.js";import{P as m}from"./PageWalker.10e4a88d.js";const d=[..."\u{1F34E}\u{1F34F}\u{1F96D}\u{1F353}\u{1F352}\u{1F350}\u{1F351}\u{1F34C}\u{1F34B}"],p=()=>{const e=i.exports.useMemo(()=>{const o=f();return o.on("ALERT",u=>{alert(u.a)}),o},[]),[r,s]=i.exports.useState("\u{1F34E}");return i.exports.useEffect(()=>e.on("GACHA",()=>s(d.filter(o=>o!==r)[Math.floor(Math.random()*7.9)])),[r,e]),n(c,{children:[t(a,{onClick:()=>e.emit("GACHA"),children:"GACHA"}),t(a,{onClick:()=>e.emit("ALERT",{a:r}),children:"Alert"}),t("style",{children:`
      @keyframes demo{
        from{
